...
void getup(){
	...
	system("title Bilal Khan Topper World Internship");
	system("cls");
	textcolor("aqua");
	printf("\n  %c",218);
	int x;
	...
	gotoxy(28,21);
	printf("Press Space to Pause/Play Game");
	gotoxy(10,23);
	textcolor("black","lightgreen");
	printf(" Bilal Khan Topper World Internship ");
	textcolor(10);
}
void score(int sc){
	gotoxy(69,21);
